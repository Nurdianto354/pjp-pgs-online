            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active"><a href="{{ route('master_data.kelas.index') }}">Data Kelas</a>
                        </li>
                    </ol>
                </div>
            </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <button type="button" class="btn btn-success btn-sm mb-2" data-toggle="modal"
                                data-target="#modalInput" id="tambahData">
                                            ...
                                            <td class="text-center">
                                                <div class="btn-group">
                                                    <button type="button" class="btn btn-warning btn-sm update-data"
                                                        ...
                                                        data-id="{{ $data->id }}" data-nama="{{ $data->nama }}" data-divisi_id="{{ $data->divisi_id }}">
                                                        <i class="far fa-edit"></i> Ubah
                                                    </button>
                                                    <button type="button" class="btn btn-danger btn-sm delete-data"
                                                        data-id="{{ $data->id }}"
                                                        data-nama="{{ $data->nama }} data-divisi="{{ $data->getDivisi->nama }}">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form name="input-data" method="POST" action="{{ route('master_data.kelas.create') }}"
                        onsubmit="return validateForm()">
                        @csrf
                        <input type="hidden" id="id" name="id">
                        <div class="form-group">
                            <label>Kelas</label>
                            <input type="text" class="form-control" placeholder="Input kelas" id="nama"
                                name="nama">
                        </div>
                        <small class="form-text text-danger error-nama" style="margin-top: -15px;">Harap masukan kelas
                            !</small>
                        <div class="form-group">
                            <label>Divisi</label>
                            <select name="divisi_id" class="form-control select2-divisi select2-success"
                        ...
                        <small class="form-text text-danger error-nama" style="margin-top: -15px;">Harap masukan divisi
                            !</small>
...
@section('js')
    <script>
        ...
        function validateForm() {
            ...
            const fields = [{
                    selector: '#nama',
                    errorSelector: '.error-nama'
                },
                {
                    selector: '#divisi_id',
                    errorSelector: '.error-divisi-id'
                },
            ];
        ...
        $(document).on('click', '.delete-data', function(e) {
            ...
            Swal.fire({
                ...
                text: "Ingin menghapus data kelas " + nama + " dari divisi " + divisi + " ini !",
                icon: "warning",
                showDenyButton: true,
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        type: "POST",
                        url: "{{ url('/master-data/kelas/delete') }}/" + id,
                        success: function(data) {
                            if (data.status == "success") {
                                toastMixin.fire({
                                    icon: 'success',
                                    title: 'Berhasil menghapus data kelas ' + nama + " dari divisi " + divisi,
                                });
                                ...
                                toastMixin.fire({
                                    icon: 'error',
                                    title: 'Gagal, menghapus data kelas ' + nama + " dari divisi " + divisi,
                                });
                            }
                        }
                    });
