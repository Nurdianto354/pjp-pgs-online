...
use App\Models\Kelompok\MasterData\Kelompok;
...
class KelompokController extends Controller
{
    ...
    {
        $datas = Kelompok::orderBy('created_at', 'DESC')->get();

        return view('pages.kelompok.master_data.kelompok.index', compact('datas'));
    }
